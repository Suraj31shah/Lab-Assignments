...
# Write you code here
movies=movies.drop(['movie_imdb_link',
        'plot_keywords',
        'movie_title',
        'actor_2_name',
        'actor_3_name'],
...
imdb_filtered=movies[movies['num_voted_users']>25000]
imdb_sorted=imdb_filtered.sort_values(by='imdb_score', ascending=False)
IMDb_Top_250=imdb_sorted.head(250).copy()
...
mean_reviews=grouped[['num_critic_for_reviews', 'num_user_for_reviews']].mean()
mean_reviews
